...
const NAV = [
  ...
  ['Timetable', CalendarClock, '/timetable', ['super_admin', 'admin', 'principal', 'teacher']],
  ['Homework', BookMarked, '/homework', ['super_admin', 'admin', 'principal', 'teacher']],
  ['Fees', CircleDollarSign, '/fees', ['super_admin', 'admin', 'principal']],
  ['Notice Board', Bell, '/notices', ['super_admin', 'admin', 'principal', 'teacher']],
  ['Leave', ClipboardList, '/leave', ['super_admin', 'admin', 'principal', 'teacher']],
